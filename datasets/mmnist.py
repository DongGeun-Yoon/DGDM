...
class MovingMNIST(Dataset):
    def __init__(self, root, is_train=True, n_frames_input=10, n_frames_output=10, num_objects=[2], transform=None, dataset_config=None, stage='train'):
    ...
    def __getitem__(self, idx):
        ...
        images = images.reshape((length, w, r, w, r)).transpose(
            0, 2, 4, 1, 3).reshape((length, r * r, w, w)) # B F C H W


        inputs = images[:self.n_frames_input]
